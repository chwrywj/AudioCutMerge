...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getVideoOrAudioMetaData:(audioPath,callback)=>{
    ffmpegClass.getVideoOrAudioMetaData(audioPath,callback);
  },

  selectAudioForCut: (audioFilePath) => ipcRenderer.invoke('selectAudioForCut', audioFilePath),
  audioInfoForCut: (callback) => ipcRenderer.on('audioInfoForCut', callback),
